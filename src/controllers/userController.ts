...
export const updateUser = async (id: number, req: Request) => {
  try {
    ...
    // Education
    if (body.lastEducation !== undefined) updateData.lastEducation = body.lastEducation;
    ...
    // Experience
    if (body.lastCompany !== undefined) updateData.lastCompany = body.lastCompany;
    if (body.lastPosition !== undefined) updateData.lastPosition = body.lastPosition;
    if (body.workStartDate !== undefined) updateData.workStartDate = body.workStartDate ? new Date(body.workStartDate) : null;
    if (body.workEndDate !== undefined) updateData.workEndDate = body.workEndDate ? new Date(body.workEndDate) : null;
    if (body.jobDescription !== undefined) updateData.jobDescription = body.jobDescription;
    if (body.reasonLeaving !== undefined) updateData.reasonLeaving = body.reasonLeaving;
