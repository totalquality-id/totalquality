              ...
              <div className="bg-white border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <button
                    ...
                    className="group relative p-3 sm:p-4 border border-gray-200 hover:border-[#25D366] hover:shadow-lg transition-all duration-300 overflow-hidden"
                    type="button"
                  >
                    <div className="absolute inset-0 bg-[#25D366]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div className="relative">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto rounded-full bg-[#25D366] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                        <svg
                      ...
                      <p className="text-xs font-light text-[#364153] mt-2">WhatsApp</p>
                    </div>
                  </button>

                  <button
                    onClick={() => shareToSocialMedia("instagram")}
                    className="group relative p-3 sm:p-4 border border-gray-200 hover:border-[#E4405F] hover:shadow-lg transition-all duration-300 overflow-hidden"
                    type="button"
                  >
                    ...
                    <div className="relative">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                        <svg
                          className="w-5 h-5 sm:w-7 sm:h-7 text-white"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                      ...
                      <p className="text-xs font-light text-[#364153] mt-2">Instagram</p>
                    </div>
                  </button>

                  <button
                    onClick={() => shareToSocialMedia("twitter")}
                    className="group relative p-3 sm:p-4 border border-gray-200 hover:border-black hover:shadow-lg transition-all duration-300 overflow-hidden"
                    type="button"
                  >
                    <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div className="relative">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto rounded-full bg-black flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                        <svg
                      ...
                      <p className="text-xs font-light text-[#364153] mt-2">Twitter</p>
                    </div>
                  </button>

                  <button
                    onClick={() => shareToSocialMedia("facebook")}
                    className="group relative p-3 sm:p-4 border border-gray-200 hover:border-[#1877F2] hover:shadow-lg transition-all duration-300 overflow-hidden"
                    type="button"
                  >
                    <div className="absolute inset-0 bg-[#1877F2]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div className="relative">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto rounded-full bg-[#1877F2] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                        <svg
                          className="w-5 h-5 sm:w-7 sm:h-7 text-white"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                      ...
                      <p className="text-xs font-light text-[#364153] mt-2">Facebook</p>
                    </div>
                  </button>
                </div>
              </div>
